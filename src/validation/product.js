...
const productValidation = (data) => {
    const schema = Joi.object({
        ...
        img: Joi.string().min(3).message('Please choose image for this product.').required(),
        description: Joi.string().min(12).message('Min. number of characters for product description is 12.').max(128).message('Max. number of characters for product description is 128.').required(),
    });
